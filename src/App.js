  ...
  return (
    ...
    <div className="landing-page"  id="home">
      ...
      <nav className="navbar4">
        <div className="logo4"><img style={{ width: '50px', height: '50px' }} src={logo}></img></div>
        <ul className="menu4">
      ...
      <div className="features4" id="features4">
      ...
      {/* Full-width Image */}
      <div className="full-width-image4" id="services4">
        <img src={service_image} alt="Full Width" />
      </div>

      {/* Footer */}
      <footer className="footer4" id="contact4">
